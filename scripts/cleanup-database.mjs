/**
 * Database Cleanup Script (ESM version)
 * 
...
async function cleanupDatabase() {
  ...
  try {
    ...
    // Use Convex HTTP API format
    const apiUrl = convexUrl.replace(/\/$/, '');
    const response = await fetch(`${apiUrl}/api/mutation/cleanup/cleanDatabase`, {
      method: 'POST',
      headers: {
