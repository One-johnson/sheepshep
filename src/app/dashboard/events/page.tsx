        ...
        <div className="grid gap-4 grid-cols-2 lg:grid-cols-4">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-[10px] sm:text-xs text-muted-foreground">All active events</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <CardContent>
              ...
              <p className="text-[10px] sm:text-xs text-muted-foreground">In current month</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <CardContent>
              ...
              <p className="text-[10px] sm:text-xs text-muted-foreground">Future events</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-xs sm:text-sm font-medium">By Type</CardTitle>
            ...
            <CardContent>
              ...
              <p className="text-[10px] sm:text-xs text-muted-foreground">Event types in use</p>
            </CardContent>
          </Card>
        </div>
      )}
